    ...
    public static class VTConsole
    {
        ...
        static VTConsole()
        {
            bool TryEnableInput(out ConsoleModeInput result)
            {
                ...
                if (!GetStdInputHandle(out var handle))
                    return false;
            ...
            bool TryEnableOutput(out ConsoleModeOutput result)
            {
                ...
                if (!GetStdOutputHandle(out var handle))
                    return false;
        ...
        public static bool GetStdOutputHandle(out IntPtr handle)
        {
        ...
        public static bool GetStdInputHandle(out IntPtr handle)
        {
